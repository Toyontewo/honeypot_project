...
1. **Geographical Analysis**: The majority of attacks originated from countries X, Y, and Z.
   <img src="all_files/images/geo.jpg" alt="Honeypot" width="600" height="500"/>
2. **IP Frequency**: Specific IPs showed repeated login attempts, indicating potentially automated attacks.
   <img src="all_files/images/ip_bar.jpg" alt="Honeypot" width="600" height="500"/>
   <img src="all_files/images/Figure_1.png" alt="Honeypot" width="600" height="500"/>
